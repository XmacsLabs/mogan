  ...
  <div>
    ...
    <div v-if="showModal" :class="$style.modalBackdrop" @click.self="showModal = false">
      <div :class="$style.modalContent">
        ...
        <button :class="$style.smallButton" @click="downloadFile">Download Windows</button>
        <button :class="$style.smallButton" @click="downloadFileGreen">Download Windows(Portable Software)</button>
        <button :class="$style.closeButton" @click="showModal = false">Close</button>
      </div>
    </div>
  </div>
</template>
