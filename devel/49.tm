...
<\body>
  <tmdoc-title|Fine tuning of xmake configuration>

  <section|Tasks>

  <tabular|<tformat|<twith|table-width|1par>|<twith|table-hmode|exact>|<table|<row|<cell|Chore>|<cell|49_1>|<cell|<value|jk>>|<cell|Add
  compile options>>|<row|<cell|Chore>|<cell|49_2>|<cell|<value|jk>>|<cell|Move
  tests of commute and swap>>|<row|<cell|Chore>|<cell|49_3>|<cell|>|<cell|Choose
  faster linker when built by gcc>>|<row|<cell|Chore>|<cell|49_4>|<cell|>|<cell|Remove
