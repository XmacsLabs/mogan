...
<\body>
  ...
  Documentation in markdown format can be viewed on Codeberg/Gitee/Github
  directly and will also be rendered on <slink|https://mogan.app>.

  For new users, those docs should be concise and straightforward. For
  developers, those docs should help them get involved in an easy way.

  The handy scripts for developers in the <shell|bin> directory should also
  ...
  <\wide-tabular>
    ...
    green>|<cwith|10|10|2|2|cell-background|>|<table|<row|<\cell>
      ...
      Import Markdwon doc from branch 1.x
    </cell>>|<row|<\cell>
      Chore
    </cell>|<\cell>
      5_2
