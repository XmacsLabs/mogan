...
<\body>
  <tmdoc-title|Build and Test on wasm>

  <section|Tasks>

  <tabular|<tformat|<twith|table-width|1par>|<twith|table-hmode|exact>|<table|<row|<cell|Chore>|<cell|32_1>|<cell|Da>|<cell|xmake
  config on wasm>>|<row|<cell|Chore>|<cell|32_2>|<cell|Da>|<cell|Remove dep
