...
## 2025/12/29 修复upgradetm.cpp的映射关系
### What
- 删除"newfigure","new-figure""new-table"；
- `style_rename`放的是TeXmacs文件和tmu文件的映射关系，不需要放"newfigure","new-figure""new-table",如果放了，映射关系就是"newfigure"="new-figure-new-table"