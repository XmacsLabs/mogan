...
<\body>
  ...
  add slidemove plugin>>|<row|<cell|Chore>|<cell|77_7>|<cell|v1.2.6>|<cell|<value|da>>|<\cell>
    Replace screens with slideshow when page rendering is page/book/panorama
    and it is in screens
  </cell>>|<row|<cell|Chore>|<cell|77_6>|<cell|v1.2.6>|<cell|<value|da>>|<cell|Use
  mogan_app_id for Research/Beamer/Draw/Code>>|<row|<cell|Chore>|<cell|77_5>|<cell|v1.2.6>|<cell|<value|da>>|<cell|Beamer:
  set default style to beamer and <scm|make-screens>>>|<row|<cell|Feature>|<cell|77_4>|<cell|v1.2.6>|<cell|<value|da>>|<cell|Mogan
  Beamer on macOS and Windows>>|<row|<cell|Bug>|<cell|77_3>|<cell|v1.2.5>|<cell|<value|da>>|<cell|Fix
  exec_pattern when base_file_name is url_none>>|<row|<cell|Perf>|<cell|77_2>|<cell|v1.2.5>|<cell|<value|da>>|<cell|Perf
  tuning on <cpp|picture_is_cached>>>|<row|<cell|Chore>|<cell|77_1>|<cell|v1.2.5>|<cell|<value|da>>|<\cell>
    Remove the preferences action in the focus toolbar in beamer mode
  </cell>>>>>
