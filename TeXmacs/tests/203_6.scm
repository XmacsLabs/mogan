...
(define (test-latex-to-texmacs)
  ...
  (check (tree->stree (latex->texmacs (parse-latex "\\begin{align} \n A=BC \n \\end{align}")))
         => '(document (align (tformat (table (row (cell "A=B*C") (cell (eq-number))))))))
