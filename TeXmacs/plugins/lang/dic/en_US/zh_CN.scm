...
("For mathematical formulas, enter math mode and press Ctrl+V for OCR insertion." "对于数学公式，建议进入数学模式后直接Ctrl+V进行OCR插入。")
("For mathematical formulas, enter math mode and press Command+V for OCR insertion." "对于数学公式，建议进入数学模式后直接Command+V进行OCR插入。")
("This image-based recognition is better for mixed text and formulas." "此图片上方识别功能更适合文本和数学公式混合的情况。")
