...
("For mathematical formulas, enter math mode and press Ctrl+V for OCR insertion." "纯公式，在数学模式直接Ctrl+v识别插入！")
("For mathematical formulas, enter math mode and press Command+V for OCR insertion." "纯公式，在数学模式直接Command+v识别插入！")
