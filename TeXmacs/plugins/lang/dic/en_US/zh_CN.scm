...
("this page" "")
("this row" "此行")
("(This feature can also be intelligently triggered using the Ctrl Shift V shortcut.)" "(此功能也可以使用Ctrl+Shift+v快捷键智能触发)")
("three times" "三次")
...
("yes" "是")
("you can also obtain" "")
("You can try using Enter, Esc, the Up arrow, and the Down arrow keys~" "可以尝试一下enter、esc、上方向、下方向~")
