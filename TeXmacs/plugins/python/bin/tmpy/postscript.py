...
from tmpy.protocol import texmacs_escape


class PSOutDummy:
    """Dummy class for use with ps_out.

    We return an instance of this class to avoid output after evaluation
    in the TeXmacs plugin of ps_out.
    """
...
if platform.system() == "Windows":
    pdf_out_tmp_file = (
        os.getenv("TEXMACS_HOME_PATH") + "\\system\\tmp\\" + pdf_out_tmp_file
    )
else:
    pdf_out_tmp_file = (
        os.getenv("TEXMACS_HOME_PATH") + "/system/tmp/" + pdf_out_tmp_file
    )
