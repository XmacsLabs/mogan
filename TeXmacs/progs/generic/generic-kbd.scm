...
(kbd-map
  ...
  ("macos up" (go-start))
  ("macos down" (go-end))
  ("macos left" (kbd-select-if-active kbd-start-line))
  ("macos right" (kbd-select-if-active kbd-end-line))
  ...
  ("cmd left" (kbd-select-if-active macos-cmd-left))
  ("cmd right" (kbd-select-if-active macos-cmd-right))
  ("cmd S-left" (kbd-select macos-cmd-left))
  ("cmd S-right" (kbd-select macos-cmd-right))
