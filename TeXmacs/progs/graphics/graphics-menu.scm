...
(menu-bind graphics-mode-menu
  ...
  ("Arc(start point -> center -> end point)" (graphics-set-mode '(edit arc_cp)))
  ("Circle(origin -> point)" (graphics-set-mode '(edit carc_cp)))
  ---
...
(tm-menu (graphics-insert-icons)
  ...
  ((check (balloon (icon "tm_arc_cp_mode.xpm") "Insert arcs by center and two points")
          "v" (== (graphics-mode) '(edit arc_cp)))
   (graphics-set-mode '(edit arc_cp)))
  ((check (balloon (icon "tm_carc_cp_mode.xpm") "Insert circles by center and point")
          "v" (== (graphics-mode) '(edit carc_cp)))
   (graphics-set-mode '(edit carc_cp)))
  /
...
(define (gr-mode->string s)
  (cond ((== s '(edit point)) "point")
        ...
        ((== s '(edit arc)) "arc")
        ((== s '(edit carc)) "circle")
        ((== s '(edit arc_cp)) "arc(start -> center -> end)")
        ((== s '(edit carc_cp)) "circle(cneter -> point)")
        ((== s '(edit text-at)) "text")
