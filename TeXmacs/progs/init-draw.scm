...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; MODULE      : init-draw.scm
;; DESCRIPTION : This is the Mogan Draw initialization file 
...
(lazy-define (graphics graphics-markup) arrow-with-text arrow-with-text* circle three-points-circle)
(define-secure-symbols arrow-with-text arrow-with-text* circle three-points-circle)
;;(display* "time: " (- (texmacs-time) boot-start) "\n")
;;(display* "memory: " (texmacs-memory) " bytes\n")
...
(lazy-format (convert images image-format)
             postscript pdf xmgrace svg xpm jpeg ppm gif png)
