...
("GNU TeXmacs comes without any form of legal warranty" "GNU TeXmacs 没有任何形式的法律保证")
...
("armenian" "亚美尼亚语")
("arrow" "箭头")
("arrow-with-text" "带文本的箭头(文本在上)")
("arrow-with-text*" "带文本的箭头(文本在下)")
("arrows" "箭头")
("article" "文章")
...
("crop" "剪裁")
("cross" "叉")
("current graphical mode" "当前的绘图模式")
("current version" "当前版本")
("cursors" "游标")
("curve intersections" "曲线间交点")
("curve points" "曲线点")
("curve" "曲线")
("custom tab" "自定义制表符")
("custom tab" "自定义制表符")
