...
enum pencil_kind { pencil_none, pencil_simple, pencil_standard, pencil_brush };
...
class pencil {
  ...
  pencil (color col, SI w, pencil_cap c, pencil_join j= join_round,
          double l= 2.0);
  pencil (brush br, SI w, pencil_cap c, pencil_join j= join_round,
          double l= 2.0);
  pencil (tree t, int alpha, SI w, pencil_cap c, pencil_join j= join_round,
          double l= 2.0);
...
inline bool
operator== (const pencil& a, const pencil& b) {
  return a.rep == b.rep;
}
