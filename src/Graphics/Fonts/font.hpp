 ...
 * For font name without the index suffix, the face_index is 0, font_basename is the same with font_name.
 * For font name with the index suffix, the face_index is extracted, font_basename is font_name without the suffix.
 */
