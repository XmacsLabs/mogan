...
poor_extended_font_rep::poor_extended_font_rep (string name, font b, double f,
                                                double l)
...
void
poor_extended_font_rep::advance_glyph (string s, int& pos, bool ligf) {
...
poor_extended_font (font base, double xf, double lw) {
  ...
  return make (font, name, tm_new<poor_extended_font_rep> (name, base, xf, lw));
}
