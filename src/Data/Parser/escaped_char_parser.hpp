...
public:
  ...
  inline bool hex_with_8_bits () {
    return bool_features->contains (HEX_WITH_8_BITS);
  }
  ...
  inline bool hex_with_16_bits () {
    return bool_features->contains (HEX_WITH_16_BITS);
  }
  ...
  inline bool hex_with_32_bits () {
    return bool_features->contains (HEX_WITH_32_BITS);
  }
  ...
  inline bool octal_upto_3_digits () {
    return bool_features->contains (OCTAL_UPTO_3_DIGITS);
  }
