...
detach_data (tree doc, new_data& data) {
  ...
  data->init   = tree_hashmap<string> (UNINIT, extract (doc, "initial"));
  data->fin    = tree_hashmap<string> (UNINIT, extract (doc, "final"));
  data->ref    = tree_hashmap<string> (UNINIT, extract (doc, "references"));
  data->aux    = tree_hashmap<string> (UNINIT, extract (doc, "auxiliary"));
  data->att    = tree_hashmap<string> (UNINIT, extract (doc, "attachments"));
