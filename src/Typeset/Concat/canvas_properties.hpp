...
void get_canvas_horizontal (canvas_properties props, SI bx1, SI bx2, SI& x1,
                            SI& x2, SI& scx);
void get_canvas_vertical (canvas_properties props, SI by1, SI by2, SI& y1,
                          SI& y2, SI& scy);
box put_scroll_bars (canvas_properties props, box b, path ip, box inner, SI scx,
                     SI scy);
