...
box_rep::get_cell_extents (SI& l, SI& r) {
  (void) l; (void) r;
  FAIL_WITH_MSG ("cell box expected");
}
...
box_rep::get_leaf_left_pos () {
  ...
  FAIL_WITH_MSG ("this box is not textual");
  return 0;
}
...
box_rep::get_leaf_tree () {
  failed_error << "The box is " << box (this) << "\n";
  FAIL_WITH_MSG ("no tree attached to this box");
  return "";
}
...
box_rep::get_leaf_box () {
  failed_error << "The box is " << box (this) << "\n";
  FAIL_WITH_MSG ("no box attached to this box");
  return box ();
}
...
box_rep::get_leaf_lazy () {
  failed_error << "The box is " << box (this) << "\n";
  FAIL_WITH_MSG ("no lazy attached to this box");
  return lazy ();
}
