...
struct lazy_document {
  ...
  inline lazy_document (edit_env env, tree t, path ip)
      : rep (tm_new<lazy_document_rep> (env, t, ip)) {
    rep->ref_count= 1;
  }
};
...
struct lazy_surround {
  ...
  inline lazy_surround (edit_env env, tree t, path ip)
      : rep (tm_new<lazy_surround_rep> (env, t, ip)) {
    rep->ref_count= 1;
  }
  inline lazy_surround (array<line_item> a, array<line_item> b, lazy par,
                        path ip)
      : rep (tm_new<lazy_surround_rep> (a, b, par, ip)) {
    rep->ref_count= 1;
  }
};
...
struct lazy_hidden {
  ...
  inline lazy_hidden (edit_env env, tree t, path ip)
      : rep (tm_new<lazy_hidden_rep> (env, t, ip)) {
    rep->ref_count= 1;
  }
};
...
struct lazy_dynamic_case {
  ...
  inline lazy_dynamic_case (edit_env env, tree t, path ip)
      : rep (tm_new<lazy_dynamic_case_rep> (env, t, ip)) {
    rep->ref_count= 1;
  }
};
...
struct lazy_relay {
  ...
  inline lazy_relay (edit_env env, tree t, path ip)
      : rep (tm_new<lazy_relay_rep> (env, t, ip)) {
    rep->ref_count= 1;
  }
};
