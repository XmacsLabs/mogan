...
tex_rubber_font_rep::tex_rubber_font_rep (string name, string trl_name,
                                          string family2, double size2, int dpi2,
                                          int dsize2)
...
font
tex_rubber_font (string trl_name, string family, double size, int dpi, int dsize) {
  // 验证输入是否为0.5倍数，如果不是则修正
  ...
  string name=
      "tex-rubber:" * family * size_str * "@" * as_string (dpi);
  return make (
      font, name,
