...
/*! QTMTreeModel is a QT model around a TeXmacs tree.
 ...
 notifications of modifications performed on the tree elements by e.g. the
 editor. Currently we are very crude and simply reset the whole (!) model each
 time there's a modification. This is extremely wasteful, but a complete
