...
rubber_assemble_font_rep::rubber_assemble_font_rep (string name, font base2)
  ...
  initialized << true;
  larger << virtual_font (base, "emu-alt-large", base->effective_size (), hdpi, vdpi, false);
...
rubber_assemble_font_rep::search_font (string s, string& r) {
  ...
  if (starts (s, "<left-")) {
    ...
    if (pos > 6) {
      ...
      else if (r == "lfloor") code= virt->dict["<rubber-lfloor-#>"];
      else if (r == "rfloor") code= virt->dict["<rubber-rfloor-#>"];
      else if (r == "lceil") code= virt->dict["<rubber-lceil-#>"];
      else if (r == "rceil") code= virt->dict["<rubber-rceil-#>"];
      else if (r == ".") code= virt->dict["<rubber-nosymbol-#>"];
      else if (r == "nosymbol") code= virt->dict["<rubber-nosymbol-#>"];
      else if (r == "|") code= virt->dict["<rubber-bar-#>"];
      else if (r == "||") code= virt->dict["<rubber-parallel-#>"];
      else if (r == "interleave") code= virt->dict["<rubber-interleave-#>"];
      else if (r == "sqrt") code= virt->dict["<rubber-sqrt-#>"];
