...
is_metadata_env (tree u) {
  return is_tuple (u, "\\begin-frontmatter") ||
         ...
         is_tuple (u, "\\begin-keywords") || is_tuple (u, "\\begin-abstract");
}

bool
is_metadata (tree u) {
  return is_tuple (u, "\\accepted") || is_tuple (u, "\\address") ||
         is_tuple (u, "\\additionalauthors") || is_tuple (u, "\\addtocmark") ||
         is_tuple (u, "\\addtocmark*") || is_tuple (u, "\\affiliation") ||
         is_tuple (u, "\\altaffiliation") ||
         is_tuple (u, "\\altaffiliation*") || is_tuple (u, "\\author") ||
         is_tuple (u, "\\authornote") || is_tuple (u, "\\authorrunning") ||
         is_tuple (u, "\\author*") || is_tuple (u, "\\category") ||
         is_tuple (u, "\\category*") || is_tuple (u, "\\ccsdesc") ||
         is_tuple (u, "\\ccsdesc*") || is_tuple (u, "\\CCSXML") ||
         is_tuple (u, "\\classification") || is_tuple (u, "\\contrib") ||
         is_tuple (u, "\\contrib*") || is_tuple (u, "\\copyrightholder") ||
         is_tuple (u, "\\copyrightyear") || is_tuple (u, "\\curaddr") ||
         is_tuple (u, "\\date") || is_tuple (u, "\\dedicatory") ||
         is_tuple (u, "\\doc-acm") || is_tuple (u, "\\doc-terms") ||
         is_tuple (u, "\\email") || is_tuple (u, "\\email*") ||
         is_tuple (u, "\\homepage") || is_tuple (u, "\\homepage*") ||
         is_tuple (u, "\\institute") || is_tuple (u, "\\footnotetext") ||
         is_tuple (u, "\\footnotetext*") || is_tuple (u, "\\keywords") ||
         is_tuple (u, "\\maketitle") || is_tuple (u, "\\noaffiliation") ||
         is_tuple (u, "\\numberofauthors") || is_tuple (u, "\\orcid") ||
         is_tuple (u, "\\pacs") || is_tuple (u, "\\preprint") ||
         is_tuple (u, "\\pagenumbering") || is_tuple (u, "\\received") ||
         is_tuple (u, "\\revised") || is_tuple (u, "\\subclass") ||
         is_tuple (u, "\\subjclass") || is_tuple (u, "\\subjclass*") ||
         is_tuple (u, "\\subtitle") || is_tuple (u, "\\subtitlenote") ||
         is_tuple (u, "\\terms") || is_tuple (u, "\\title") ||
         is_tuple (u, "\\titlenote") || is_tuple (u, "\\titlerunning") ||
         is_tuple (u, "\\title*") || is_tuple (u, "\\thanks") ||
         is_tuple (u, "\\thanks*") || is_tuple (u, "\\tmacm") ||
         is_tuple (u, "\\tmaffiliation") || is_tuple (u, "\\tmarxiv") ||
         is_tuple (u, "\\tmemail") || is_tuple (u, "\\tmfnaffiliation") ||
         is_tuple (u, "\\tmfnemail") || is_tuple (u, "\\tmfnhomepage") ||
         is_tuple (u, "\\tmhomepage") || is_tuple (u, "\\tmkeywords") ||
         is_tuple (u, "\\tmmisc") || is_tuple (u, "\\tmmsc") ||
         is_tuple (u, "\\tmnote") || is_tuple (u, "\\tmpacs") ||
         is_tuple (u, "\\tmsep") || is_tuple (u, "\\tmSep") ||
         is_tuple (u, "\\tmsubtitle") || is_tuple (u, "\\toctitle") ||
         is_tuple (u, "\\tocauthor") || is_tuple (u, "\\translator") ||
         is_tuple (u, "\\urladdr");
}
...
clean_latex_title_markup (tree t) {
  ...
  if (is_latex_titlenote (t) || is_tuple (t, "\\tmmisc", 1) ||
      is_tuple (t, "\\tmsubtitle", 1))
    return concat ();
  ...
  for (i= 0; i <= n; i++) {
    ...
    if (i == n || is_tuple (u, "\\and")) {
      ...
      author_data << tree (APPLY, "\\author-note", cltm (u[1]));
             ...
             is_tuple (u, "\\tmemail", 1) || is_tuple (u, "\\tmfnemail", 1))
...
collect_metadata_latex (tree t, array<tree> (*get_author_datas) (tree)) {
  ...
  for (i= 0; i < n; i++) {
    ...
    else if (is_tuple (u, "\\address", 1) || is_tuple (u, "\\affiliation", 1) ||
             is_tuple (u, "\\institute", 1) || is_tuple (u, "\\email", 1) ||
             is_tuple (u, "\\ead", 1)) {
...
collect_metadata (tree t, tree latex_class) {
  ...
  if (starts (s, "acm_proc_article-sp") || starts (s, "sig-alternate") ||
  ...
  else if (s == "revtex4-1") r= collect_metadata_revtex (t);
  else if (s == "svmono") r= collect_metadata_svmono (t);
  else if (s == "svjour3") r= collect_metadata_springer (t, false);
  else if (s == "llncs") r= collect_metadata_springer (t, true);
  else if (s == "IEEEconf" || s == "IEEEtran") r= collect_metadata_ieee (t);
  else r << collect_metadata_latex (t);
...
get_latex_style (tree t) {
  ...
  if (occurs ("llncs", s)) return "llncs";
  if (occurs ("svjour", s)) return "svjour";
  if (occurs ("ifacconf", s)) return "ifac";
  if (occurs ("IEEEconf", s)) return "ieeeconf";
  if (occurs ("IEEEtran", s)) return "ieeetran";
  if (occurs ("acm_proc", s)) return "acmconf";
  if (occurs ("sig-alt", s)) return "sig-alternate";
  return s;
}
